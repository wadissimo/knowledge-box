...
###### Set up #######
folder = "sounds/ger"
voices = ["de-DE-Standard-A", "de-DE-Standard-B", "de-DE-Standard-C", "de-DE-Standard-D", "de-DE-Standard-E", "de-DE-Standard-F", "de-DE-Standard-G", "de-DE-Standard-H"]
data = read_csv('../import/eng-ger.csv', skip_errors=True)
log_file = "ger-log.txt"
WORD_IDX = 1
CHECK_EXISTING = True
